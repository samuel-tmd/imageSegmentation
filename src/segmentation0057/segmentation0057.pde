...
void draw() {
  PrintWriter output;
  PImage img = loadImage("0057.jpg"); 
  PImage imgGT = loadImage("GT0057.png"); 
  output = createWriter("results0057.csv");
  ...
  // Salvando as imagens
  image(segSobel, 0, 0);
  save("segSobel_0057.jpg");

  image(segMedia, 0, 0);
  save("segMedia_0057.jpg");
  
  image(segLim, 0, 0); 
  save("segLim_0057.jpg");
  
  image(segBB, 0, 0); 
  save("segBB_0057.jpg");
  
  image(segImg, 0, 0); 
  save("segImg_0057.jpg");
}
